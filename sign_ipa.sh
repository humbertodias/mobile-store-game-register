...
IPA_UNSIGNED="platforms/ios/build/device/GuaruBus.ipa"
IPA_SIGNED="platforms/ios/build/signed.ipa"
APP="platforms/ios/build/device/GuaruBus.app"

# https://developer.apple.com > Provision Profiles > Distribution > FILL > Generate
PROVISION="doc/certificates/apple/iOS_Team_Provisioning_Profile_brpolygon4gamesguarubus.mobileprovision"
